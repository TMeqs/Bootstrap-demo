...
$(".backstretch-carousel").backstretch([  
  "panokamWeb/img/screen-bg_1.jpg"
], {
    duration: 1000,
    fade: 1000
  });
...
$(document).ready(function(){
    $('a[href=#welcome],a[href=#about], a[href=#demos], a[href=#pricing], a[href=#team], a[href=#features], a[href=#contact-us]').bind("click", function(e){
      var anchor = $(this);
